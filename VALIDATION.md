...
GitHub Actions [35182248428](https://github.com/Ranshen1209/dsh-auto-mode/actions/runs/35182248428) passed Windows, macOS and Linux test jobs and real packaged CLI acceptance on Linux. Desktop Windows prepackaged Host acceptance also passed 10 assertions with seven model reviews and exact approved edits; final Electron/ASAR qualification remains pending.

Unverified: macOS product execution, live provider APIs, interactive browser/human approval presentation, final desktop 0.1.6-alpha.1.desktop.1 installer qualification, older Harness cohorts, hostile filesystem/OS races, malicious host/plugins and installation into a user's existing Profile. Historical `docs/` and older release evidence describe their original code only and must not be used to certify this candidate.
